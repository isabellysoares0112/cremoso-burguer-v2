...
export function Menu() {
  ...
  // As categorias vêm sempre do Supabase (via /api/menu) — o que você
  // cadastra em /equipe/admin/cardapio é exatamente o que aparece aqui,
  // sem nenhuma lista fixa por trás.
        ...
        <div className="container mx-auto px-4">
          ...
          {!loading && displayedCategories.length === 0 ? (
            <div className="text-center py-16 text-muted-foreground">
              <p>O cardápio ainda não foi configurado.</p>
              <p className="text-sm mt-1">Cadastre categorias e produtos em Equipe → Cardápio.</p>
            </div>
          ) : (
            <>
